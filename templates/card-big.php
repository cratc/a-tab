...
<article class="bm-card bm-card--big<?php echo $bookmark['is_dead'] ? ' bm-card--dead' : ''; ?>">
    <?php if ($preview) : ?>
    <div class="bm-card-bg">
        <img src="<?php echo esc_url($preview); ?>" alt="<?php echo esc_attr($bookmark['title']); ?>" loading="lazy" />
    </div>
    <?php endif; ?>
